  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Content
        ...
        data-side={side}
        className={cn(
          "bg-background data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50 gap-4 border p-6 shadow-lg transition ease-in-out duration-200",
          sideStyles[side],
          className
        )}
        {...props}
...
export type { SheetContentProps, Side };
